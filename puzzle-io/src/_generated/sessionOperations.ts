...
const UserSessionValidation = () => ({
  coins: yup
    ...
    .required((message) => `${message.path} is required`),
  current: yup.object(LevelStatsValidation()),
...
export interface GlobalFormValuesTypes {
  ForgotPasswordEmailForm: Record<
    keyof IForgotPasswordEmail,
    GlobalLabelType<IForgotPasswordEmail>
  >;

  TokenPasswordForm: Record<
    keyof ITokenPassword,
    GlobalLabelType<ITokenPassword>
  >;
  ...
  ProviderSetupBaseForm: Record<
    keyof IProviderSetupBase,
    GlobalLabelType<IProviderSetupBase>
  >;
  getUserCallQuery: Record<
    keyof IgetUserCallQuery,
    GlobalLabelType<IgetUserCallQuery>
  >;
  deleteUserCallQuery: Record<
    keyof IdeleteUserCallQuery,
    GlobalLabelType<IdeleteUserCallQuery>
  >;
  updateSessionCallQuery: Record<
    keyof IupdateSessionCallQuery,
    GlobalLabelType<IupdateSessionCallQuery>
  >;
  registerUserCallQuery: Record<
    keyof IregisterUserCallQuery,
    GlobalLabelType<IregisterUserCallQuery>
  >;
  loginUserCallQuery: Record<
    keyof IloginUserCallQuery,
    GlobalLabelType<IloginUserCallQuery>
  >;
  logoutUserCallQuery: Record<
    keyof IlogoutUserCallQuery,
    GlobalLabelType<IlogoutUserCallQuery>
  >;
  forgotPasswordCallQuery: Record<
    keyof IforgotPasswordCallQuery,
    GlobalLabelType<IforgotPasswordCallQuery>
  >;
  resetPasswordCallQuery: Record<
    keyof IresetPasswordCallQuery,
    GlobalLabelType<IresetPasswordCallQuery>
  >;
}
