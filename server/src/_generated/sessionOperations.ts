...
const GridValidation = () => ({
  x: yup.number().integer((message) => `${message.path} should be integer`),
  y: yup.number().integer((message) => `${message.path} should be integer`)
});
...
const LimitsValidation = () => ({
  moves: yup.number().integer((message) => `${message.path} should be integer`),
  time: yup.number().integer((message) => `${message.path} should be integer`),
  stars: yup.number().integer((message) => `${message.path} should be integer`)
});
...
const LevelGroupValidation = () => ({
  id: yup.number().integer((message) => `${message.path} should be integer`),
  title: yup
...
const LevelValidation = () => ({
  ...
  image: yup
    ...
    .nullable()
    .trim(),
  grid: yup.object(GridValidation()),
  shifts: yup.array().of(yup.object(GridValidation())),
  limits: yup.array().of(yup.object(LimitsValidation()))
});
...
const LevelForm = () => ({
  ...
  shifts: {
    ...
    item: {
      type: "object",
      properties: { x: { type: "integer", required: false }, y: { type: "integer", required: false } },
      typeOf: "schemas",
  ...
  limits: {
    ...
    item: {
      type: "object",
      properties: {
        moves: { type: "integer", required: false },
...
const GameResultValidation = () => ({
  levelId: yup
    ...
    .nullable()
    .trim(),
  moves: yup.array().of(yup.object(GridValidation())),
  time: yup.number().integer((message) => `${message.path} should be integer`)
});
...
const UserSessionValidation = () => ({
  coins: yup.number().integer((message) => `${message.path} should be integer`),
  current: yup.object(LevelProgressValidation()),
  previous: yup.array().of(yup.object(LevelStatsValidation()))
});
...
const UserSessionForm = () => ({
  ...
  previous: {
    ...
    item: {
      ...
      required: ["levelId", "moves", "completed", "stars", "time", "stage", "scene"],
      typeOf: "schemas",
      fileName: "session.yaml",
      key: "LevelStats",
      reference: "LevelStats",
...
const UserProfileValidation = () => ({
  ...
  email: yup
    ...
    .nullable()
    .trim(),
  session: yup.object(UserSessionValidation())
});
...
const TokenBodyValidation = () => ({
  userId: yup
    ...
    .nullable()
    .trim(),
  iat: yup.number().integer((message) => `${message.path} should be integer`),
  exp: yup.number().integer((message) => `${message.path} should be integer`)
});
...
const ProviderSetupBaseValidation = () => ({
  ...
  attributes: yup
    ...
    .nullable()
    .trim(),
  provider: yup.number().integer((message) => `${message.path} should be integer`)
});
...
const ProviderSetupBaseForm = () => ({
  validSince: {
    ...
    maxLength: parseInt(``) || undefined,
    type: COREInputTypeEnum.dateTime
  },
...
): RESTRequestType<getUserCallResponse> => {
...
const deleteUserCall = (
  ...
  body?: undefined,
  options: Partial<RESTRequestType> = {}
): RESTRequestType<deleteUserCallResponse> => {
 ...
 * @throws {RequiredError}
 */
export type IupdateGameStatusCallResolver = LocalResolverType<
  IupdateGameStatusCallQuery,
  IGameResult,
  updateGameStatusInnerResponse
>;
const updateGameStatusCall = (
  queryParams?: IupdateGameStatusCallQuery,
  body?: IGameResult,
  options: Partial<RESTRequestType> = {}
): RESTRequestType<updateGameStatusCallResponse> => {
 ...
 * @throws {RequiredError}
 */
export type IupdateSessionCallResolver = LocalResolverType<
  IupdateSessionCallQuery,
  IUserSession,
  updateSessionInnerResponse
>;
const updateSessionCall = (
  queryParams?: IupdateSessionCallQuery,
  body?: IUserSession,
  options: Partial<RESTRequestType> = {}
): RESTRequestType<updateSessionCallResponse> => {
 ...
 * @throws {RequiredError}
 */
export type IregisterUserCallResolver = LocalResolverType<
  IregisterUserCallQuery,
  IUserRegister,
  registerUserInnerResponse
>;
const registerUserCall = (
  queryParams?: IregisterUserCallQuery,
  body?: IUserRegister,
  options: Partial<RESTRequestType> = {}
): RESTRequestType<registerUserCallResponse> => {
...
const loginUserCall = (
  ...
  body?: IUserLogin,
  options: Partial<RESTRequestType> = {}
): RESTRequestType<loginUserCallResponse> => {
...
const logoutUserCall = (
  ...
  body?: undefined,
  options: Partial<RESTRequestType> = {}
): RESTRequestType<logoutUserCallResponse> => {
 ...
 * @throws {RequiredError}
 */
export type IforgotPasswordCallResolver = LocalResolverType<
  IforgotPasswordCallQuery,
  IForgotPasswordEmail,
  forgotPasswordInnerResponse
>;
const forgotPasswordCall = (
  queryParams?: IforgotPasswordCallQuery,
  body?: IForgotPasswordEmail,
  options: Partial<RESTRequestType> = {}
): RESTRequestType<forgotPasswordCallResponse> => {
 ...
 * @throws {RequiredError}
 */
export type IresetPasswordCallResolver = LocalResolverType<
  IresetPasswordCallQuery,
  ITokenPassword,
  resetPasswordInnerResponse
>;
const resetPasswordCall = (
  queryParams?: IresetPasswordCallQuery,
  body?: ITokenPassword,
  options: Partial<RESTRequestType> = {}
): RESTRequestType<resetPasswordCallResponse> => {
...
try {
  ...
  if (_pre_mapped_updateGameStatusReslover) {
    pre_mapped_updateGameStatusReslover =
      _pre_mapped_updateGameStatusReslover?.default || _pre_mapped_updateGameStatusReslover;
  }
} catch (e) {
...
try {
  ...
  if (_pre_mapped_forgotPasswordReslover) {
    pre_mapped_forgotPasswordReslover =
      _pre_mapped_forgotPasswordReslover?.default || _pre_mapped_forgotPasswordReslover;
  }
} catch (e) {
